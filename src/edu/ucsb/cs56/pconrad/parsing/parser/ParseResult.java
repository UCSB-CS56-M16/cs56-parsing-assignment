 ...
 * <p><ol>
 * <li>The value which was parsed in, whatever it was (e.g., an AST, an operator, etc.)
 * <li>The next position where we are in the input; that is, where we need to start parsing from next
 * </ol><p>
 * <code>ParseResult</code> combines the above two pieces of information
 * into a single class.
 */
